...
create function get_score(name1 varchar(30),name2 varchar(30))
returns float
begin
declare a float;
declare b float;
set a=(select score from cls where name=name1);
set b=(select score from cls where name=name2);
return a-b;
end $$
