...
--
-- Table structure for table `作家_出版社`
--

DROP TABLE IF EXISTS `作家_出版社`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `作家_出版社` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `a_id` (`a_id`),
  KEY `p_id` (`p_id`),
  CONSTRAINT `作家_出版社_ibfk_1` FOREIGN KEY (`a_id`) REFERENCES `作家` (`id`),
  CONSTRAINT `作家_出版社_ibfk_2` FOREIGN KEY (`p_id`) REFERENCES `出版社` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `作家_出版社`
--

LOCK TABLES `作家_出版社` WRITE;
/*!40000 ALTER TABLE `作家_出版社` DISABLE KEYS */;
/*!40000 ALTER TABLE `作家_出版社` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `图书` (
  ...
  CONSTRAINT `图书_ibfk_1` FOREIGN KEY (`author_id`) REFERENCES `作家` (`id`),
  CONSTRAINT `图书_ibfk_2` FOREIGN KEY (`publish_id`) REFERENCES `出版社` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `book` VALUES (2,'骆驼祥子','老舍','机械工业出版社',43,'2018-10-01','你是祥子么？'),(3,'茶馆','老舍','中国文学出版社',55,'2018-10-01','老北京'),(4,'呐喊','鲁迅','人民教育出版社',50,'2019-10-01','最后的声音'),(5,'朝花夕拾','鲁迅','中国文学出版社',58,'2020-01-01','好时光'),(6,'围城','钱钟书','中国文学出版社',44,'2020-01-01','你心中的围城是什么'),(7,'林家铺子','茅盾','机械工业出版社',51,'2019-10-01',NULL),(8,'巨人传','忘了','人名教育出版社',47,'2019-10-01',NULL);
...
-- Dump completed on 2020-11-11 11:29:10
